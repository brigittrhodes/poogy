    ...
    <div className={styles.footer}>
      <div className="flex items-center justify-center space-x-4 mt-8">
        <a href="https://twitter.com/Poogy_nfts" target="_blank">
          <svg className="w-6 h-6 mx-6 mobile-sm-hw" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 21 25">
        ...
        <a href="https://discord.com/invite/JGhuBtjtfu">
          <svg className="w-6 h-6 mx-6 mobile-sm-hw" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 21 16">
